from src.sem5_cuchi.merge_k_sorted_arrays.merge_k_sorted_arrays_simple import merge_k_sorted_arrays_simple

def test_empty_input():
    assert merge_k_sorted_arrays_simple([]) == []

def test_single_empty_array():
    assert merge_k_sorted_arrays_simple([[]]) == []

def test_single_array():
    assert merge_k_sorted_arrays_simple([[1, 2, 3]]) == [1, 2, 3]
...
def test_large_arrays():
    ...
    result = merge_k_sorted_arrays_simple([array1, array2])
